...
PlasmaCore.ColorScope {
	...
	MouseArea {
		...
		RowLayout {
			...
			PlasmaComponents3.ToolButton { // TUBBADU EDIT
				id: toggleNumpad
				//Accessible.name: i18nd("plasma_lookandfeel_org.kde.lookandfeel", "Unlock")
				Layout.preferredHeight: passwordBox.implicitHeight
				Layout.preferredWidth: loginButton.Layout.preferredHeight

				icon.name: "input-dialpad" //LayoutMirroring.enabled ? "go-previous" : "go-next"
				text: "Tastierino virtuale"
				onClicked: {
		...
		Rectangle{
			...
			height: numKeyboard.height + 15
			width: numKeyboard.width + 15
			anchors.right: lockScreenUi.right
			anchors.verticalCenter: lockScreenUi.verticalCenter
			Column{
				id: numKeyboard
				spacing: 5
				anchors.centerIn: parent
				property int buttonsHeight: 60
				property int buttonsWidth: 60
				property int buttonsFontSize: 35
				Row{
					spacing: 5
					PlasmaComponents3.Button {
						text: "1"
						font.pixelSize: numKeyboard.buttonsFontSize
						height: numKeyboard.buttonsHeight
						width: numKeyboard.buttonsWidth
						onClicked: {
							mainBlock.mainPasswordBox.text += text
						}
					}
					PlasmaComponents3.Button {
						text: "2"
				...
				Row{
					...
					PlasmaComponents3.Button {
						icon.name: "keyboard-spacebar"//"unlock"
						font.pixelSize: numKeyboard.buttonsFontSize
						height: numKeyboard.buttonsHeight
						width: numKeyboard.buttonsWidth
						onClicked: {
